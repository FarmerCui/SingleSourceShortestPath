...
class BreadthFirstSearch(implements(SearchInterface)):
    """ Breadth first search class. """

    def __init__(self, graph: {}, start: int, end: int):
        """ initialize breadth first search class """
        self.graph = graph
        self.start = start
        self.end = end
        self.vertices = {}
    ...
    def __one_step_forward(self, cur_vertices) -> []:
        """ one step forward """
        new_vertices = []
        for cur_vertex in cur_vertices:
